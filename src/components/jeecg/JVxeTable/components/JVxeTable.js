  ...
  watch: {
    ...
    columns: {
      ...
      handler(columns) {
        ...
        // 判断是否开启了序号
        if (rowNumber) {
          let col = {type: 'seq', title: '序号', width: 60, fixed: 'left', align: 'center'}
          if (seqColumn) {
        ...
        if (dragSort) {
          ...
          let col = {type: JVXETypes.rowDragSort, title: '操作', width, fixed: 'left', align: 'center', cellRender: {name: JVXETypes._prefix + JVXETypes.rowDragSort}}
          if (dragSortColumn) {
