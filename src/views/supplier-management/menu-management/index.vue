...
<script>
import PermissionModal from './components/PermissionModel.vue'
import { getSupplierPermissionList } from '@/api/api'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'
import PermissionDataRuleList from '@/views/system/PermissionDataRuleList.vue'
  ...
  data() {
    return {
      ...
      url: {
        ...
        list: '/jeecg-supplier/supplier/permission/list',
        delete: '/jeecg-supplier/supplier/permission/delete',
        deleteBatch: '/jeecg-supplier/supplier/permission/deleteBatch',
      },
    }
  },
  methods: {
    loadData() {
      this.dataSource = []
      getSupplierPermissionList().then((res) => {
        if (res.success) {
