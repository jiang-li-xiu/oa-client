  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="直接主管" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="manager">
          <j-select-user-by-dep @change="managerChange" store="id" v-model="model.manager" :multi="false"></j-select-user-by-dep>
        </a-form-model-item>
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          manager:[{ required: true, message: '请选择直接主管!' }],
