...
export default {
  ...
  props: {
    ...
    changeUrl: {
      type: String,
      default: '/sys/user/changePassword'
    },
    // 供应商:account, 管理端:username
    paramsName: {
      type: String,
      default: 'username'
    }
    ...
    handleSubmit() {
      ...
      this.form.validateFields((err, values) => {
        ...
        if (!err) {
          ...
          putAction(this.url.changePassword, formData)
            .then(res => {
              if (res.success) {
