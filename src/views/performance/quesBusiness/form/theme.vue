...
import {saveUserTheme,queryUserProjectTheme,queryProjectTheme} from "@/api/performance/tduck"
export default {
    name: 'theme',
    components: {
        PreView
    ...
    methods: {
        ...
        saveUserTheme() {
            ...
            //     this.projectFormKey = +new Date()
            // })
            saveUserTheme(this.userProjectTheme).then(res=>{
                this.projectFormKey = +new Date()
            })
        },
        queryUserProjectTheme() {
            ...
            // })
            queryUserProjectTheme(this.projectKey).then(res=>{
                if(!res.data){
                    return
                }
                this.userProjectTheme = res.data
