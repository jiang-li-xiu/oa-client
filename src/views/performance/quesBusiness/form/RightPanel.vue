                    ...
                    <el-form-item v-if="activeData.__config__.changeTag" label="组件类型">
                        ...
                        >
                            <el-option-group v-for="group in tagList" :key="group.label" :label="group.label">
                                ...
                                >
                                    <svg-icon :iconClass="item.__config__.tagIcon" class="node-icon"/>
            ...
            && activeData.__config__.labelWidth !== undefined" label="显示标签"
              ...
              <span slot-scope="{ node, data }">
                <span class="node-label">
                   <svg-icon :iconClass="data.__config__?data.__config__.tagIcon:data.tagIcon" class="node-icon"/>
                  {{ node.label }}
                </span>
              </span>
                        </el-tree>
...
import TreeNodeDialog from '@/views/performance/quesBusiness/form/TreeNodeDialog'
...
import {saveFormConf} from '@/utils/performance/db'
