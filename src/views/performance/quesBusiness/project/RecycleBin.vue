<!--
 * @Author: Yelucc
 * @Date: 2021-04-29 14:51:38
 * @LastEditors: Yelucc
 * @LastEditTime: 2021-04-29 17:56:44
 * @Description: 
-->
<template>
...
export default {
    ...
    methods: {
        restoreProject(key) {
            this.$api.post('/business/questionsRecord/project/recycle/restore', {'key': key}).then(res => {
                if (res.data) {
        ...
        deleteProject(key) {
            this.$api.post('/business/questionsRecord/project/recycle/delete', {'key': key}).then(res => {
                if (res.data) {
        ...
        queryRecycleProjectPage() {
            this.$api.get('/business/questionsRecord/project/recycle/page', {
