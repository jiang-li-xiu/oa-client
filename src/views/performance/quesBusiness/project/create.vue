...
import {formConf} from '@/components/performance/generator/config'
import {queryTemplateType,queryTemplatePage,createBlankTemplate} from '@/api/performance/tduck'
export default {
    name: 'CreateProject',
    data() {
        return {
    ...
    methods: {
        queryTemplateType(){
            queryTemplateType().then(res=>{
                this.templateTypeList = res.data
            })
            // this.$api.get('/business/questionsRecord/project/template/type/list').then(res => {
            //     this.templateTypeList = res.data
            // })
        ...
        queryTemplatePage() {
            // this.$api.get('/business/questionsRecord/project/template/page', {params: this.queryParams}).then(res => {
            ...
            // })
            queryTemplatePage({params: this.queryParams}).then(res=>{
                let {records, total, size} = res.data
                    this.templateList = records
                    this.total = total
                    this.queryParams.size = size
        ...
        createBlankTemplate() {
            // this.$api.post('/business/questionsRecord/project/create', {
            ...
            createBlankTemplate({
                ...
                // console.log(res.msg)
                Cookies.set('quesID',res.msg)
                this.$router.push({path: '/evaluate/quesform', query: {key: res.msg}})
            })
        }
    }
}
