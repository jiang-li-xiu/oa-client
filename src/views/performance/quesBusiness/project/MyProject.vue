...
<script>
import DataEmpty from '@/components/performance/DataEmpty'
import dayjs from 'dayjs'
import {deleteProject,stopProject,queryProjectPage} from '@/api/performance/tduck'
...
export default {
    ...
    methods: {
        ...
        toProjectHandle(key, type) {
            this.$router.push({path: '/evaluate/quesform', query: {key: key, active: type}})
        },
        deleteProject(key) {
            // this.$api.post('/business/questionsRecord/project/delete', {'key': key}).then(res => {
            //     if (res.data) {
            //         this.msgSuccess('刪除成功')
            //         this.queryProjectPage()
            //     }
            // })
            deleteProject({'key': key}).then(res=>{
                if (res.data) {
                    // this.msgSuccess('刪除成功')
                    this.queryProjectPage()
                }
        ...
        stopProject(key) {
            // this.$api.post('/business/questionsRecord/project/stop', {'key': key}).then(res => {
            //     if (res.data) {
            //         this.msgSuccess('停止成功')
            //         this.queryProjectPage()
            //     }
            // })
            stopProject({'key': key}).then(res=>{
                    if (res.data) {
                    // this.msgSuccess('停止成功')
                    this.queryProjectPage()
                }
        ...
        queryProjectPage() {
            // this.$api.get('/business/questionsRecord/project/page', {
