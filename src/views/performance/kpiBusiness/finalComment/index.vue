        ...
        <el-form-item label="考核状态" prop="assessmentStatus">
          ...
          >
            <el-option
              ...
              v-show="dict.dictValue == '2' || dict.dictValue == '3'"
              :key="dict.dictValue"
              :label="dict.dictLabel"
              :value="dict.dictValue"
            />
    ...
    <div class="bg-border-color-10">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <router-link
              :to="'/assessment/final/data/' + scope.row.assessmentConfigureId"
              class="link-type"
            >
              <span>详情/终评</span>
            </router-link>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listAssessmentConfigureFinal(this.queryParams).then((response) => {
