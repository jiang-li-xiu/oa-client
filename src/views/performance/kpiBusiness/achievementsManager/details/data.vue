      ...
      <el-card class="box-card mb10">
        <div>
          <el-row :gutter="24" class="mb20">
            <div class="flex">
              <span class="mark-logo ml0"></span>
              <div class="check-person ml0 font-700 font-15">终评详情</div>
            </div>
          </el-row>
          <div
            v-if="form.assessmentStatus != '2' && form.assessmentStatus != '1'"
          >
            <el-row :gutter="24" class="mb20">
              <el-col :span="4">
                <b>评语内容</b>
...
export default {
  ...
  methods: {
    ...
    handleSkip(row) {
      ...
      this.$confirm(
        '是否确认跳过初评编号为"' + assessmentOptionIds + '"的数据项?',
        "警告",
        {
        ...
        .then(function () {
          return skipFirstOption(assessmentOptionIds);
        })
        .then(() => {
          this.getList();
          this.msgSuccess("操作成功");
