...
import {
  ...
  finalRecordListAssessmentOptions,
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        finalScore: [
          { required: true, validator: scorekNumber, trigger: "change" },
        ],
        finalFinishValue: [
  ...
  methods: {
    ...
    getList() {
      ...
      finalRecordListAssessmentOptions(this.queryParams).then((response) => {
