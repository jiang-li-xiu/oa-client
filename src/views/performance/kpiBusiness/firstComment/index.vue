        ...
        <el-form-item label="考核状态" prop="assessmentStatus">
          ...
          >
            <el-option
              ...
              v-show="dict.dictValue == '1' || dict.dictValue == '2'"
              :key="dict.dictValue"
              :label="dict.dictLabel"
              :value="dict.dictValue"
            />
    ...
    <div class="bg-border-color-10">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <router-link
              :to="'/assessment/first/data/' + scope.row.assessmentConfigureId"
              class="link-type"
            >
              <span>详情/初评</span>
            </router-link>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listAssessmentConfigureFirst(this.queryParams).then((response) => {
