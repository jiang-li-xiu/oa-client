<template>
  <div class="app-container">
    ...
    >
      ...
      <p v-if="form.assessmentStatus == 1">
        <el-card>
          <div>
            <el-row :gutter="24" class="mb20">
              <div class="flex">
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="0px">
              <el-form-item prop="firstComment">
                <el-row :gutter="24" class="mb20">
                  <el-col :span="23">
                    <el-input
                      resize="none"
              ...
              <div class="flex-justify-evenly">
                <div class="flex-align-center width-40">
                  ...
                  <el-input
                    class="ml0"
                    placeholder="请输入评分"
                    v-model.number="form.firstScore"
                    show-word-limit
                  >
                  </el-input>
                </div>
      ...
      <p v-else>
        ...
        <el-card class="box-card mb10">
          <div>
            ...
            <el-row v-else :gutter="24" class="mb20">
...
<script>
import {
  firstCommentAssessmentOption,
  firstListAssessmentOptions,
  getAssessmentOption,
  delAssessmentOption,
  addAssessmentOption,
  updateAssessmentOption,
  exportAssessmentOption,
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      firstListAssessmentOptions(this.queryParams).then((response) => {
    ...
    submitForm() {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          firstCommentAssessmentOption(this.form).then((response) => {
    ...
    getType(statue) {
      return statue == "1" ? this.typeStatue[1] : this.typeStatue[0];
    },
  },
};
</script>
