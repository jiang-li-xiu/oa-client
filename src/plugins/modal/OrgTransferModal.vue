<template>
  <div class="components-input-demo-presuffix">
    <a-input @click="openModal" placeholder="请选择人员/角色/部门" v-model="textVals" readOnly :disabled="disabled">
      <a-icon slot="prefix" type="cluster" title="组织架构" />
...
export default {
  ...
  methods: {
    ...
    openModal() {
      this.show = true //打开弹窗
      this.$refs.innerDepartSelectModal.showModel(this.checkedData)
    },
    initComp(textVals) {
      this.textVals = textVals
    },
