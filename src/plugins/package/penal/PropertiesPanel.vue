  ...
  <div class="process-panel__container" :style="{ width: `${this.width}px` }">
    <el-collapse v-model="activeTab">
      ...
      <el-collapse-item name="condition" v-if="conditionFormVisible" key="condition">
        ...
        <flow-condition :conditions="conditions" :condition-list="conditionList" @ok="conditionsOk" :business-object="elementBusinessObject" :type="elementType" />
      </el-collapse-item>
      <!-- 先关闭表单 -->
      <el-collapse-item name="condition" v-if="formVisible" key="form">
        <div slot="title" class="panel-tab__title"><i class="el-icon-s-order"></i>表单设置</div>
        <element-form-config :id="elementId" :type="elementType" />
      </el-collapse-item>
...
import ElementFormConfig from "./form/FlowFormConfig";
import UserTaskListeners from "./listeners/UserTaskListeners";
import CopyForSelect from "./copy-for/CopyFor";
/**
 * 侧边栏
 */
export default {
